...
#   DOTNET_SDK_TAG      - .NET SDK image tag (default: 8.0.423-bookworm-slim)
#   DOTNET_RUNTIME_TAG  - .NET runtime image tag (default: 8.0.29-bookworm-slim)
#
# Multi-arch: supports linux/amd64 and linux/arm64 via TARGETARCH.

ARG DOTNET_SDK_TAG=8.0.423-bookworm-slim
ARG DOTNET_RUNTIME_TAG=8.0.29-bookworm-slim
