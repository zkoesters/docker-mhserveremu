...
#   DOTNET_SDK_TAG      - .NET SDK image tag (default: 8.0.424-bookworm-slim)
#   DOTNET_RUNTIME_TAG  - .NET runtime image tag (default: 8.0.30-bookworm-slim)
#
# Multi-arch: supports linux/amd64 and linux/arm64 via TARGETARCH.

ARG DOTNET_SDK_TAG=8.0.424-bookworm-slim
ARG DOTNET_RUNTIME_TAG=8.0.30-bookworm-slim
