...
| `AUTH_ADDRESS`                                        | `localhost`                                | :white_check_mark: |                    |                    |
| `AUTH_PORT`                                           | `8080`                                     | :white_check_mark: |                    |                    |
...
| `USE_JSON_DB_MANAGER`                                 | `false`                                    | :white_check_mark: |                    |                    |
| `PLAYERMANAGER_USE_JSON_DB_MANAGER`                   | `false`                                    |                    | :white_check_mark: | :white_check_mark: |
| `NEWS_URL`                                            | `http://localhost/news`                    | :white_check_mark: |                    |                    |
| `PLAYERMANAGER_NEWS_URL`                              | `http://localhost/news`                    |                    | :white_check_mark: | :white_check_mark: |
| `MAX_BACKUP_NUMBER`                                   | `5`                                        | :white_check_mark: |                    |                    |
| `BACKUP_INTERVAL_MINUTES`                             | `15`                                       | :white_check_mark: |                    |                    |
| `LOAD_ALL_PROTOTYPES`                                 | `false`                                    | :white_check_mark: |                    |                    |
| `USE_EQUIPMENT_SLOT_TABLE_CACHE`                      | `false`                                    | :white_check_mark: |                    |                    |
...
| `AUTO_UNLOCK_AVATARS`                                 | `true`                                     | :white_check_mark: |                    |                    |
| `AUTO_UNLOCK_TEAMUPS`                                 | `true`                                     | :white_check_mark: |                    |                    |
| `ALLOW_SAME_GROUP_TALENTS`                            | `false`                                    | :white_check_mark: |                    |                    |
| `DISABLE_INSTANCED_LOOT`                              | `false`                                    | :white_check_mark: |                    |                    |
| `DISABLE_ACCOUNT_BINDING`                             | `false`                                    | :white_check_mark: |                    |                    |
| `DISABLE_CHARACTER_BINDING`                           | `true`                                     | :white_check_mark: |                    |                    |
| `USE_PRESTIGE_LOOT_TABLE`                             | `false`                                    | :white_check_mark: |                    |                    |
...
| `GAZILLIONITE_BALANCE_FOR_NEW_ACCOUNTS`               | `5000`                                     | :white_check_mark: |                    |                    |
| `ES_TO_GAZILLIONITE_CONVERSION_RATIO`                 | `2.25`                                     | :white_check_mark: |                    |                    |
...
| `STORE_HOME_PAGE_URL`                                 | `http://localhost/store`                   | :white_check_mark: |                    |                    |
| `STORE_HOME_BANNER_PAGE_URL`                          | `http://localhost/store/images/banner.png` | :white_check_mark: |                    |                    |
| `STORE_HEROES_BANNER_PAGE_URL`                        | `http://localhost/store/images/banner.png` | :white_check_mark: |                    |                    |
| `STORE_COSTUMES_BANNER_PAGE_URL`                      | `http://localhost/store/images/banner.png` | :white_check_mark: |                    |                    |
| `STORE_BOOSTS_BANNER_PAGE_URL`                        | `http://localhost/store/images/banner.png` | :white_check_mark: |                    |                    |
| `STORE_CHESTS_BANNER_PAGE_URL`                        | `http://localhost/store/images/banner.png` | :white_check_mark: |                    |                    |
| `STORE_SPECIALS_BANNER_PAGE_URL`                      | `http://localhost/store/images/banner.png` | :white_check_mark: |                    |                    |
| `STORE_REAL_MONEY_URL`                                | `http://localhost/store/gs-bundles.html`   | :white_check_mark: |                    |                    |
...
Note: Nightly and versions after 0.7.0 renamed many variables to reflect new config sections; use the nightly-specific names when running those images.
