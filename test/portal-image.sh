...
expected = [
  ...
  {"repository" => "https://github.com/zkoesters/MHServerEmu.git", "ref" => "portal-1.0.1", "commit" => "fada7c84bddd08f1510d9edf95cc6d869fbf96f0", "version_dir" => "1.0.1", "tag" => "portal-1.0.1-fada7c84bddd", "dockerfile" => "Dockerfile"},
  {"repository" => "https://github.com/zkoesters/MHServerEmu.git", "ref" => "portal-1.0.1", "commit" => "fada7c84bddd08f1510d9edf95cc6d869fbf96f0", "version_dir" => "1.0.1", "tag" => "portal-1.0.1-fada7c84bddd-alpine", "dockerfile" => "Dockerfile.alpine"}
]
